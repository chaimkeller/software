...
/*       READ IN STATUS FILE, THEN INPUT PARAMETERS */
    ...
    o__1.ofnmlen = 20;
	buff[0] = 0;
	sprintf(buff, "%s%s", drivlet, ":/jk_c/PLACLIS2.TXT");
	o__1.ofnm = buff;
    ...
    ioin__1.infile = buff; //"C:/jk_c/SCANLIST.TXT";
    ioin__1.inex = &exists;
    ioin__1.inopen = 0;
    ioin__1.innum = 0;
    ioin__1.innamed = 0;
    ...
    ioin__1.infilen = 20;
	buff[0] = 0;
	sprintf(buff, "%s%s", drivlet, ":/jk_c/PLACLIST.OUT" );
    ioin__1.infile = buff; //"C:/jk_c/PLACLIST.OUT";
    ioin__1.inex = &exists;
    ioin__1.inopen = 0;
    ioin__1.innum = 0;
    ioin__1.innamed = 0;
	...
	buff[0] = 0;
	sprintf(buff, "%s%s", drivlet, ":/jk_c/PLACLIST.OUT" );
	o__1.ofnm = buff; //"C:/jk_c/PLACLIST.OUT";
	o__1.orl = 0;
	o__1.osta = "OLD";
	o__1.oacc = 0;
	o__1.ofm = 0;
...
/*       NOW WRITE STATUS FILE */
    ...
    ioin__1.infile = buff; //"C:/jk_c/STATUS.TXT";
    ioin__1.inex = &exists;
    ioin__1.inopen = 0;
    ioin__1.innum = 0;
    ioin__1.innamed = 0;
...
/*       PULL IN THE DTM TILE SCHEMATIC */
    ...
    o__1.ofnmlen = 18;
	buff[0] = 0;
	sprintf(buff, "%s%s", drivlet, ":/DTM/DTM-MAP.LOC" );
    o__1.ofnm = buff; //"C:/DTM/DTM-MAP.LOC";
    o__1.orl = 0;
    o__1.osta = "OLD";
    o__1.oacc = 0;
    o__1.ofm = 0;
