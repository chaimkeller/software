...
L550:
	...
	if (WhereJK != 0)
	{
		...
		if ( f =fopen(bufFileName, "w" ) ) 
		{
			...
			}else if (TemperatureModel == 0 || TemperatureModel == 2 || TemperatureModel == 4) { //no added terrestrial refraction, or TR removed at end of calculation
				//the reason for adding it and then subtracting it in the end that it is possible that the TR will change which peaks are
				//visible and therefore change the shape of the profile
...
/* 260     FORMAT(F9.4,2X,F9.4,2X,F8.2,4(3X,F8.3),3X,F5.3) */
	...
	/* Computing 2nd power */
		...
		// fixed bug on 051825 which had substituted distd for distd//////////////////////////////////////////////////////
		////////////////////////////////////////////////////////////////////////
