      ...
      If world = True Then
       ...
       ElseIf world = False Then
          ...
          If myfile = sEmpty Then
             ...
             MsgBox "Can't find: " & drivcities$ + "citynams_w1255.txt", vbExclamation + vbOKOnly, "Calendar button error"
          Else
             On Error GoTo cb25
             cityfound% = 0
             filcit% = FreeFile
             Open drivcities$ + "citynams_w1255.txt" For Input As #filcit%
             Do Until EOF(filcit%)
        ...
        If myfile <> sEmpty Then
           ...
           For i% = 1 To nnpnt%
              ...
              If dista <= val(Text3.Text) Then
                 LineColorProf = QBColor(14)
              Else
                 LineColorProf = QBColor(1)
                 End If
              If i% = 1 Then
                 mapgraphfm.Picture1.PSet (xcord, ycord), LineColorProf
                 xo = xcord
                 yo = ycord
              Else
                 mapgraphfm.Picture1.Line (xo, yo)-(xcord, ycord), LineColorProf
                 xo = xcord
                 yo = ycord
                 End If
           Next i%
...
Private Sub Form_Load()
   ...
   GDMDIform.StatusBar1.Panels(1).Text = "Profile dispayed..."
   ...
   If crosssection = False Then
        If HorizMode% = 1 Then
           mapgraphfm.Caption = "Eastern horizon profile"
        ElseIf HorizMode% = 2 Then
           mapgraphfm.Caption = "Western horizon profile"
           End If
        plotfile$ = App.Path & "\profile.txt"
'        If world = False Then
